...
class MomentumRapidityStudy(object):
    ...
    def plot_mass_vs_momentum(self):
        ...
        plt.title('Masses of D+ peak in 3 (p⊥) Momentum Regions ')
        plt.ylabel('Mass [Gev]')
        plt.xlabel('p⊥ Region')
        plt.grid(True)
        ...
        plt.xlabel('p⊥ Region')
        plt.grid(True)
        plt.savefig("MomentumRapidityStudy/plot_D+smass_vs_momentum.png")
        plt.show()

        plt.errorbar(region_n, m2_m1, yerr = m2_m1_err, fmt="o", barsabove=True, capsize=10)
        plt.title('Mass difference between D+(s) and D+ in 3 (p⊥) Momentum Regions ')
        plt.ylabel('$M_{D+(s)}$-$M_{D+}$ [Gev]')
        plt.xlabel('p⊥ Region')
        plt.grid(True)
        plt.savefig("MomentumRapidityStudy/plot_massdiff_vs_momentum.png")
        plt.show()

        plt.errorbar(region_n, s1, yerr=s1_err, fmt="o", barsabove=True,label='D+',markersize = 4, capsize=10)
        plt.errorbar(region_n, s2, yerr=s2_err, fmt="o", barsabove=True,label='D+(s)',markersize = 4, capsize=10)
        plt.title('Spread of D+ and D+(s) peaks for 3 (p⊥) Momentum Regions')
    ...
    def plot_mass_vs_rapidity(self):
        ...
        plt.errorbar(region_n, m1, yerr = m1_err, fmt="o", barsabove=True, capsize=10)
        plt.title('Masses of D+ peak in 4 Rapidity (η) Regions')
        plt.ylabel('Mass [Gev]')
        plt.xlabel('η Region')
        plt.grid(True)
        ...
        plt.xlabel('η Region')
        plt.grid(True)
        plt.savefig("MomentumRapidityStudy/plot_D+smass_vs_rapidity.png")
        plt.show()

        plt.errorbar(region_n, m2_m1, yerr = m2_m1_err, fmt="o", barsabove=True, capsize=10)
        plt.title('Mass difference between D+(s) and D+ in 4 Rapidity (η) Regions')
        plt.ylabel('$M_{D+(s)}$-$M_{D+}$ [Gev]')
        plt.xlabel('η Region')
        plt.grid(True)
        ...
        plt.errorbar(region_n, s1, yerr=s1_err, fmt="o", barsabove=True,label='D+',markersize = 4, capsize=10)
        plt.errorbar(region_n, s2, yerr=s2_err, fmt="o", barsabove=True,label='D+(s)',markersize = 4, capsize=10)
        plt.title('Spread of D+ and D+(s) peaks for 4 Rapidity (η) Regions')
        plt.ylabel('Mass [Gev]')
        plt.xlabel('η Region')
        plt.legend()
        plt.grid(True)
